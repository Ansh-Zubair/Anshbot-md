...
global.channelLink = "https://whatsapp.com/channel/0029VbC8yvyADTOF6hRmDu3K";
global.ytch = "ANSH TECHIE";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\https://whatsapp.com/channel/0029VbC8yvyADTOF6hRmDu3K'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhhttps://chat.whatsapp.com/Fwn5wKiKtfFGWWw4GPnUjF?mode=gi_t
                }, { quoted: message });
                return;
            }
        }
